...
def get_hkdf_key(master_key):
    ...
    salt = os.urandom(16)
    info = b"SecCheck_01"  # TODO: NON CRITICO. Si può evitare questo leak alla "attaccante Eve" ?
...
async def xchg_key(id: str, otp: str, key: str,):
    ...
    if check_TOTP(seed, otp.encode()):
        ...
        server_key = dh_public_key.public_bytes(Encoding.PEM, PublicFormat.SubjectPublicKeyInfo)
